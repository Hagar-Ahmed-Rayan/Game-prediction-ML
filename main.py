...
data = pd.read_csv(
    r"E:\study\ASU\semester 8\Pattern Recognetion\project\milestone 2\milestone2\milestone2\games-classification-dataset.csv")
...
models = [
    ...
    ('Random Forest', RandomForestClassifier(n_estimators=100, max_depth=5, min_samples_split=5, min_samples_leaf=4,
                                             max_features='sqrt', random_state=32)),
    # ('Random Forest', RandomForestClassifier(n_estimators=2, max_depth=5, min_samples_split=5, min_samples_leaf=4,
    #                                          max_features='sqrt', random_state=32)),
    # ('Random Forest', RandomForestClassifier(n_estimators=10, max_depth=5, min_samples_split=5, min_samples_leaf=4,
    #                                          max_features='sqrt', random_state=32)),
    # ('Random Forest', RandomForestClassifier(n_estimators=100, max_depth=5, min_samples_split=5, min_samples_leaf=4,
    #                                          max_features='sqrt', random_state=32)),
    # ('Random Forest', RandomForestClassifier(n_estimators=100, max_depth=5, min_samples_split=5, min_samples_leaf=4,
...
training_time = [total_time_of_each_model_for_training[0], total_time_of_each_model_for_training[1],
                 total_time_of_each_model_for_training[2], total_time_of_each_model_for_training[3]]
models = ['Logistic Regression', 'Decision Tree', 'Random Forest', 'Gradient Boosting']
...
yticks = [i * 0.1 for i in range(0, 12)]
plt.yticks(yticks)
...
testing_time = [total_time_of_each_model_for_testing[0], total_time_of_each_model_for_testing[1],
                total_time_of_each_model_for_testing[2], total_time_of_each_model_for_testing[3]]
models = ['Logistic Regression', 'Decision Tree', 'Random Forest', 'Gradient Boosting']
